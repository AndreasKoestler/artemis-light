...
//!    opportunities are available (for example, a strategy might listen to a stream of borrow
//!    and supply logs see if there are any delinquent borrowers that can be liquidated)
//!
